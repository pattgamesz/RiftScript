...
export function timeToLevel(startLevel, endLevel, xpPerHour) {
...
export function triggerNav(page) {
...
export function waitFor(selector, timeout = 3e3) {
...
export function buildEquipmentDropdown(slotKey, currentItemId) {
...
export function getEquipmentSummaryStats() {
    const totals = {};
...
export function renderEquipmentSummary(page) {
...
export function renderEquipmentSlots(page) {
...
export function populateEquipmentFromUser(userData) {
...
export function getMonsterRegion(monster) {
...
export function getActionRegion(action) {
...
export function getMonsterBlockPercent(monster) {
    if (!monster) return 0;
...
export function controlInput(label, id, value, step = 1, suffix = "") {
    return `
        <div class="cs-control-row">
...
export function renderMonsterList(page) {
...
export function selectMonster(page, actionId) {
...
export function renderDropsTable(page, actionId) {
...
export function getRarityClass(chance) {
...
export function getRarityLabel(chance) {
...
export function setFetched(page, id, value) {
    page.find(`#${id}`).val(value);
    page.find(`#${id}-fetched`).text(value);
  }
export function buildSimConfig(page) {
...
export function runSimulation(page) {
    if (!selectedActionId) {
...
export function updateTTL(page, xpPerHour) {
